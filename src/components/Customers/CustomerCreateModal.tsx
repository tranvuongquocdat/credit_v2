...
import { CreateCustomerParams, CustomerStatus } from '@/models/customer';
...
// Schema cho form thêm khách hàng
  ...
  const handleSubmit = async (values: CustomerFormValues) => {
    ...
    try {
      const customerData: CreateCustomerParams = {
        ...values,
        store_id: values.store_id || (stores.length > 0 ? stores[0].id : ''),
      };
      ...
      setError(err.message || 'Có lỗi xảy ra khi thêm khách hàng. Vui lòng thử lại sau.');
    } finally {
