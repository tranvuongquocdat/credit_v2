...
export default function PawnTable({ transactions, isLoading }: PawnTableProps) {
  // Calculate totals from the passed transactions
  const allTransactions: PawnTransaction[] = [];
  transactions.forEach((item: PawnTransaction) => {
    ...
    return (
      <Card>
        <CardHeader className="py-3">
          <CardTitle className="text-base font-bold bg-purple-500 text-white p-2 rounded">
            Giao dịch cầm đồ
          </CardTitle>
        </CardHeader>
        <CardContent>
