...
const TRANSACTION_TYPES = {
  EXPENSE_SALARY: "tra_luong",
  EXPENSE_INTEREST: "tra_lai_phi",
  EXPENSE_CONSUMPTION: "chi_tieu_dung",
  EXPENSE_FUND: "chi_tra_quy",
  EXPENSE_ADVANCE: "tam_ung",
  EXPENSE_COMMISSION: "hoa_hong_chi",
  EXPENSE_TICKET: "chi_ve",
  EXPENSE_OFFICE: "chi_van_phong",
  EXPENSE_OTHER: "chi_khac",
} as const;

// Transaction type display information
const transactionTypeMap = {
  [TRANSACTION_TYPES.EXPENSE_SALARY]: {
    label: "Trả lương",
    color: "bg-red-50 text-red-700 border-red-200 hover:bg-red-100",
  },
  [TRANSACTION_TYPES.EXPENSE_INTEREST]: {
    label: "Trả lãi phí",
    color: "bg-red-50 text-red-700 border-red-200 hover:bg-red-100",
  },
  [TRANSACTION_TYPES.EXPENSE_CONSUMPTION]: {
    label: "Chi tiêu dùng",
    color: "bg-red-50 text-red-700 border-red-200 hover:bg-red-100",
  },
  [TRANSACTION_TYPES.EXPENSE_FUND]: {
    label: "Chi trả quỹ",
    color: "bg-red-50 text-red-700 border-red-200 hover:bg-red-100",
  },
  [TRANSACTION_TYPES.EXPENSE_ADVANCE]: {
    label: "Tạm ứng",
    color: "bg-red-50 text-red-700 border-red-200 hover:bg-red-100",
  },
  [TRANSACTION_TYPES.EXPENSE_COMMISSION]: {
    label: "Hoa hồng",
    color: "bg-red-50 text-red-700 border-red-200 hover:bg-red-100",
  },
  [TRANSACTION_TYPES.EXPENSE_TICKET]: {
    label: "Chi vé",
    color: "bg-red-50 text-red-700 border-red-200 hover:bg-red-100",
  },
  [TRANSACTION_TYPES.EXPENSE_OFFICE]: {
    label: "Chi văn phòng",
    color: "bg-red-50 text-red-700 border-red-200 hover:bg-red-100",
  },
  [TRANSACTION_TYPES.EXPENSE_OTHER]: {
    label: "Chi khác",
    color: "bg-red-50 text-red-700 border-red-200 hover:bg-red-100",
  },
};
      ...
      <div className="container mx-auto px-4 py-6">
        <div className="flex flex-col gap-6">
          <div className="flex justify-between items-center">
            <h1 className="text-2xl font-bold text-gray-800">Phiếu chi: {currentStore?.name || ''}</h1>
          ...
          <div className="flex flex-col sm:flex-row justify-between gap-2 mb-4">
            <div className="flex gap-2">
              ...
              >
                <Plus className="mr-1 h-3.5 w-3.5" /> Tạo phiếu chi
              </Button>
            </div>
        ...
        <Dialog open={isFormModalOpen} onOpenChange={setIsFormModalOpen}>
          <DialogContent className="sm:max-w-[500px]">
            <DialogHeader>
              <DialogTitle>{selectedRecord ? 'Chỉnh sửa phiếu chi' : 'Tạo phiếu chi mới'}</DialogTitle>
            </DialogHeader>
            ...
            <DialogFooter>
              ...
              >
                ...
                {selectedRecord ? 'Cập nhật' : 'Tạo phiếu chi'}
              </Button>
            </DialogFooter>
          </DialogContent>
        </Dialog>
